  ...
  return (
    <div className='navbar1'>
      <div className="navbar-links row">
          <nav className="navbar navbar-expand-lg navba=r-light dark m-3 mt-0 pt-0">
          <div data-aos="slide-right" className="navbar-links_logo col-lg-3 col-sm-10 d-block mx-auto">
          
          <img src={logo} alt="logo mx-auto" />
            </div>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav row container">
                <li className="nav-item col text-center mt-2 mx-auto">
